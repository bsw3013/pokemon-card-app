  ...
  return (
    <div className={`filter-page slide-up ${selectedCard ? 'modal-open' : ''}`}>
      ...
      <div className="filter-toolbar">
        ...
        <div className="grid-columns-control" style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', background: 'rgba(255,255,255,0.05)', padding: '0.3rem 0.8rem', borderRadius: '999px', border: '1px solid var(--border-color)' }}>
